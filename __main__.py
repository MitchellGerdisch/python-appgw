...
azure_native.network.ApplicationGateway(
            ...
            backend_http_settings_collection=[
                azure_native.network.ApplicationGatewayBackendHttpSettingsArgs(
                    ...
                    cookie_based_affinity=azure_native.network.ApplicationGatewayCookieBasedAffinity.ENABLED,
            ...
            request_routing_rules=[
                azure_native.network.ApplicationGatewayRequestRoutingRuleArgs(
                    name="routingRule1",
                    rule_type=azure_native.network.ApplicationGatewayRequestRoutingRuleType.BASIC,
            ...
            sku=azure_native.network.ApplicationGatewaySkuArgs(
                ...
                family=azure_native.network.ApplicationGatewaySkuFamily.GENERATION_2,
                capacity=2,
            ),
            probes=[
            ...
            ssl_profiles=[
                azure_native.network.ApplicationGatewaySslProfileArgs(
                    name="routing-nc-dev-ssl-profile",
                    ssl_policy=azure_native.network.ApplicationGatewaySslPolicyArgs(
                        policy_name=azure_native.network.ApplicationGatewaySslPolicyName.APP_GW_SSL_POLICY20220101,
                        policy_type=azure_native.network.ApplicationGatewaySslPolicyType.PREDEFINED,
                    )
                )
            ],
        )